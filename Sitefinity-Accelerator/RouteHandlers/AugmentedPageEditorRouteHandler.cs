...
namespace SitefinityAccelerator.RouteHandlers
{
    /// <inheritdoc />
    /// <summary>
    /// Page editor router incorporating additional security trimming.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public class AugmentedPageEditorRouteHandler : MvcPageEditorRouteHandler
    {
        private readonly List<IToolboxItemFilter> _filters;

        public AugmentedPageEditorRouteHandler(List<IToolboxItemFilter> filters)
        {
            _filters = filters;
        }
